...
### Goals
- Keep a TempleOS like feel and do not make horrible refactoring and API changes which break compatability with most existing TempleOS applications (ahh, ahh, ahh Zenith, sorry I had to sneeze).
